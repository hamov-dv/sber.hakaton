...
public class SimpleProducer {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        properties.setDestination(ClientApiRequest.class.getName());
        ...
        String topic = properties.getDestinationWithNodeId();
        ...
        Callable callable = new Callable() {
            ...
            public Object call() throws Exception {
                String result;
                TransportConsumerKafka transportConsumer = new TransportConsumerKafka(134, groupId, bootstrapServer, Arrays.asList("reply-" + topic), new MessageHandler<ConsumerRecord<String, byte[]>>() {
